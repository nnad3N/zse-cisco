...
})(["position:absolute;min-height:90vh;width:100%;z-index:20;background-color:", ";padding:", " ", ";display:grid;grid-template-columns:repeat(auto-fit,minmax(40rem,auto));row-gap:", ";column-gap:", ";align-content:flex-start;", "{column-gap:", ";padding:", " ", ";}", "{grid-template-columns:100%;padding:", " ", ";}", "{padding:", " ", ";}img{border-radius:0;}"], ({
  theme
}) => theme.colors.mainColor, ({
  theme
}) => theme.padding.xV, ({
