...
const Image = ({
  ...
  if (image) {
    ...
    return /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxDEV)("h5", {
      children: "Image was required but not provided"
    }, void 0, false, {
      fileName: _jsxFileName,
      lineNumber: 31,
      columnNumber: 12
...
const ListItem = ({
  ...
  return /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxDEV)(_ListItem_styles__WEBPACK_IMPORTED_MODULE_4__.ListItemWrapper, {
    ...
    children: [/*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxDEV)(_ListItem_styles__WEBPACK_IMPORTED_MODULE_4__.Bullet, {}, void 0, false, {
      ...
      lineNumber: 11,
      columnNumber: 7
    }, undefined), linked ? /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxDEV)(_atoms_FunctionalLink_FunctionalLink__WEBPACK_IMPORTED_MODULE_2__.default, {
      link: link,
...
})(["display:flex;align-items:", ";&:not(:last-child){margin-bottom:1.5rem;}a{font-size:", ";}"], ({
  wrap
}) => wrap ? 'flex-start' : 'center', ({
  theme
...
})(["position:relative;min-width:2.2rem;min-height:2.2rem;border-radius:50%;margin-right:1.5rem;background-color:", ";&::before{position:absolute;content:'';top:50%;left:50%;min-width:1.2rem;min-height:1.2rem;border-radius:50%;transform:translate(-50%,-50%);background-color:", ";}"], ({
  theme
}) => theme.colors.accentColor, ({
  theme
...
/* harmony import */ var _atoms_Image_Image__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @atoms/Image/Image */ "./components/atoms/Image/Image.js");
/* harmony import */ var _atoms_LineHorizontal_LineHorizontal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @atoms/LineHorizontal/LineHorizontal */ "./components/atoms/LineHorizontal/LineHorizontal.js");
/* harmony import */ var _templates_PageTile_PageTile__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @templates/PageTile/PageTile */ "./components/templates/PageTile/PageTile.js");
/* harmony import */ var _molecules_ListItem_ListItem__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @molecules/ListItem/ListItem */ "./components/molecules/ListItem/ListItem.js");
...
const StyledTitle = styled_components__WEBPACK_IMPORTED_MODULE_11___default().h1.withConfig({
  displayName: "CiscoCourse__StyledTitle",
  componentId: "sc-mpisfd-0"
})(["font-size:", ";"], ({
  theme
}) => theme.fontSize.headerMobile);
const InfoSection = styled_components__WEBPACK_IMPORTED_MODULE_11___default().section.withConfig({
  displayName: "CiscoCourse__InfoSection",
  componentId: "sc-mpisfd-1"
...
const InfoWrapper = styled_components__WEBPACK_IMPORTED_MODULE_11___default().div.withConfig({
  displayName: "CiscoCourse__InfoWrapper",
  componentId: "sc-mpisfd-2"
})(["display:flex;justify-content:space-between;margin:0 auto;", "{width:max-content;flex-direction:column;align-items:flex-start;}"], ({
  theme
}) => theme.mq.laptopLarge);
const InfoComponent = styled_components__WEBPACK_IMPORTED_MODULE_11___default().div.withConfig({
  displayName: "CiscoCourse__InfoComponent",
  componentId: "sc-mpisfd-3"
})(["display:flex;align-items:center;color:", ";&:not(:last-child){margin-right:8rem;}span{font-size:", ";}", "{&:not(:last-child){margin-right:0;margin-bottom:4rem;}}"], ({
  theme
}) => theme.colors.white, ({
  theme
...
const StyledSpan = styled_components__WEBPACK_IMPORTED_MODULE_11___default().span.withConfig({
  displayName: "CiscoCourse__StyledSpan",
  componentId: "sc-mpisfd-4"
})(["color:", ";font-weight:600;margin-right:0.6rem;"], ({
  theme
}) => theme.colors.accentColor);
const ImageWrapper = styled_components__WEBPACK_IMPORTED_MODULE_11___default().div.withConfig({
  displayName: "CiscoCourse__ImageWrapper",
  componentId: "sc-mpisfd-5"
})(["width:7rem;margin-right:3rem;"]);
const StyledList = styled_components__WEBPACK_IMPORTED_MODULE_11___default().ul.withConfig({
  displayName: "CiscoCourse__StyledList",
  componentId: "sc-mpisfd-6"
})(["margin-top:4rem;font-size:", ";"], ({
  theme
}) => theme.fontSize.body);
const StyledItem = styled_components__WEBPACK_IMPORTED_MODULE_11___default().span.withConfig({
  displayName: "CiscoCourse__StyledItem",
  componentId: "sc-mpisfd-7"
})(["inline-size:40rem;overflow-wrap:break-word;", "{inline-size:100%;}"], ({
  theme
}) => theme.mq.mobileLarge);
const PageTileWrapper = styled_components__WEBPACK_IMPORTED_MODULE_11___default().div.withConfig({
  displayName: "CiscoCourse__PageTileWrapper",
  componentId: "sc-mpisfd-8"
})(["display:flex;flex-wrap:wrap;justify-content:space-between;", "{flex-direction:column;align-items:center;}"], ({
  theme
}) => theme.mq.laptopLarge);
const StyledTileHeader = styled_components__WEBPACK_IMPORTED_MODULE_11___default().h4.withConfig({
  displayName: "CiscoCourse__StyledTileHeader",
  componentId: "sc-mpisfd-9"
})(["", "{max-width:75%;}"], ({
  theme
}) => theme.mobileLarge);
...
const CiscoCourse = ({
  ...
  return /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)("div", {
    children: [/*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(_templates_PageHeader_PageHeader__WEBPACK_IMPORTED_MODULE_2__.default, {
      image: image,
      children: /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(_atoms_LineVertical_LineVertical__WEBPACK_IMPORTED_MODULE_3__.default, {
        large: true,
      ...
      lineNumber: 115,
      columnNumber: 7
    }, undefined), /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(_templates_PageWrapper_PageWrapper__WEBPACK_IMPORTED_MODULE_4__.default, {
      column: true,
      children: richText.map(({
        title,
        content,
        id
      }) => /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(_templates_PageSection_PageSection__WEBPACK_IMPORTED_MODULE_5__.default, {
        children: [/*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(_atoms_LineVertical_LineVertical__WEBPACK_IMPORTED_MODULE_3__.default, {
          large: true,
          children: /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(StyledTitle, {
            children: title
          }, void 0, false, {
            fileName: _jsxFileName,
            lineNumber: 124,
          ...
          lineNumber: 123,
          columnNumber: 13
        }, undefined), /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(_molecules_RichText_RichText__WEBPACK_IMPORTED_MODULE_6__.default, {
          children: content
        }, void 0, false, {
          fileName: _jsxFileName,
          lineNumber: 126,
      ...
      lineNumber: 120,
      columnNumber: 7
    }, undefined), /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(InfoSection, {
      children: /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(InfoWrapper, {
        children: iconInfo.map(({
          caption,
          value,
          icon,
          id
        }) => /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(InfoComponent, {
          children: [/*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(ImageWrapper, {
            children: /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(_atoms_Image_Image__WEBPACK_IMPORTED_MODULE_7__.default, {
              image: icon
            }, void 0, false, {
              fileName: _jsxFileName,
              lineNumber: 135,
            ...
            lineNumber: 134,
            columnNumber: 15
          }, undefined), /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(StyledSpan, {
            children: caption
          }, void 0, false, {
            fileName: _jsxFileName,
            lineNumber: 137,
      ...
      short: true,
      children: /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(_templates_PageSection_PageSection__WEBPACK_IMPORTED_MODULE_5__.default, {
        wide: true,
        children: [/*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(_atoms_LineHorizontal_LineHorizontal__WEBPACK_IMPORTED_MODULE_8__.default, {
          large: true,
          children: /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)("h1", {
            children: listTitle
          }, void 0, false, {
          ...
          lineNumber: 145,
          columnNumber: 11
        }, undefined), /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(PageTileWrapper, {
          children: listComponent.map(({
            title,
            listItems,
            id
          }) => /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(_templates_PageTile_PageTile__WEBPACK_IMPORTED_MODULE_9__.default, {
            wide: true,
            children: [/*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(_atoms_LineVertical_LineVertical__WEBPACK_IMPORTED_MODULE_3__.default, {
              children: /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(StyledTileHeader, {
                children: title
              }, void 0, false, {
                fileName: _jsxFileName,
                lineNumber: 152,
              ...
              lineNumber: 151,
              columnNumber: 17
            }, undefined), /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(StyledList, {
              children: listItems.map(({
                item,
                id
              }) => /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(_molecules_ListItem_ListItem__WEBPACK_IMPORTED_MODULE_10__.default, {
                wrap: true,
                children: /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxDEV)(StyledItem, {
                  children: item
                }, void 0, false, {
                  fileName: _jsxFileName,
                  lineNumber: 157,
...
HeroCourses.propTypes = {
  data: prop_types__WEBPACK_IMPORTED_MODULE_1___default().shape({
    ...
    heroCourses: prop_types__WEBPACK_IMPORTED_MODULE_1___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_1___default().object)).isRequired,
    id: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().number),
    title: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().string)
  })
};
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _atoms_Image_Image__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @atoms/Image/Image */ "./components/atoms/Image/Image.js");
/* harmony import */ var _PageHeader_styles__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./PageHeader.styles */ "./components/templates/PageHeader/PageHeader.styles.js");
/* harmony import */ var react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react/jsx-dev-runtime */ "react/jsx-dev-runtime");
/* harmony import */ var react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__);
...
const PageHeader = ({
  ...
  return /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxDEV)(_PageHeader_styles__WEBPACK_IMPORTED_MODULE_3__.PageHeaderWrapper, {
    children: /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxDEV)(_PageHeader_styles__WEBPACK_IMPORTED_MODULE_3__.ContentWrapper, {
      children: [children, /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxDEV)(_PageHeader_styles__WEBPACK_IMPORTED_MODULE_3__.ImageWrapper, {
        children: /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxDEV)(_atoms_Image_Image__WEBPACK_IMPORTED_MODULE_2__.default, {
          image: image
        }, void 0, false, {
          fileName: _jsxFileName,
...
})(["width:100%;display:flex;align-items:center;justify-content:space-between;h1{max-width:40rem;}", "{width:max-content;flex-direction:column;align-items:flex-start;h1{max-width:max-content;}}", "{width:50rem;h1{max-width:30rem;}}", "{width:100%;}"], ({
  theme
}) => theme.mq.desktop, ({
  theme
}) => theme.mq.tablet, ({
...
})(["width:80rem;max-width:80rem;display:flex;align-items:center;justify-content:center;", "{width:100%;padding-top:", ";}", "{padding-top:", ";}"], ({
  theme
}) => theme.mq.desktop, ({
  theme
}) => theme.padding.xV, ({
...
PageSection.propTypes = {// children: childrenShape,
};
...
})(["margin-bottom:", ";background-color:", ";border-radius:", ";box-shadow:", ";padding:", ";max-width:", ";min-width:", ";&:last-child{margin-bottom:0;}", "{min-width:", ";}", "{margin-bottom:", ";padding:", ";}"], ({
  theme
}) => theme.padding.xV, ({
  theme
}) => theme.colors.white, ({
...
})(["display:flex;flex-direction:column;margin-top:", ";padding:", ";background-color:", ";border-radius:", ";width:", ";color:", ";", "{width:100%;}", "{padding:", ";}"], ({
  theme
}) => theme.dimensions.richTextMarginTop, ({
  theme
}) => theme.dimensions.tilePadding, ({
...
})(["padding:", " ", ";min-height:", ";display:flex;align-items:center;justify-content:center;flex-direction:", ";", "{padding:", " ", ";min-height:unset;}"], ({
  theme
}) => theme.padding.xV, ({
  theme
}) => theme.padding.m, ({
