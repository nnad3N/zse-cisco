...
})(["width:20rem;max-width:30rem;&:first-child{width:30rem;max-width:40rem;margin-right:5rem;}", "{width:100%;&:first-child{margin-right:0;margin-bottom:10rem;}}"], function (_ref17) {
